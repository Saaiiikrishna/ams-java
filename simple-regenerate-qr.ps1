...
try {
    ...
    Write-Host "Failed to verify tables: $($_.Exception.Message)" -ForegroundColor Yellow
}

Write-Host "`nQR Code regeneration completed!" -ForegroundColor Green
Write-Host "All QR codes now point to: http://restaurant.local:57977/menu/table/[TABLE_ID]" -ForegroundColor White
Write-Host "Test the QR codes by scanning them with your phone!" -ForegroundColor Yellow
