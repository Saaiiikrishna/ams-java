...
import com.example.attendancesystem.organization.model.Order;
...
public interface OrderRepository extends JpaRepository<Order, Long> {
     ...
     */
    List<Order> findByOrganizationAndStatusOrderByCreatedAtDesc(Organization organization, Order.OrderStatus status);
    
    /**
     * Find orders by organization and status in
     */
    List<Order> findByOrganizationAndStatusInOrderByCreatedAtDesc(Organization organization, List<Order.OrderStatus> statuses);
     ...
     */
    long countByOrganizationAndStatus(Organization organization, Order.OrderStatus status);
