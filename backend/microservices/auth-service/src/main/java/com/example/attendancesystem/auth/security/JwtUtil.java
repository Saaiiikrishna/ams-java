...
public class JwtUtil {
    ...
    /**
     * Generate access token for user from User Service
     */
    public String generateTokenForUser(String username, String userType, Long userId) {
        Map<String, Object> claims = new HashMap<>();
    ...
    /**
     * Generate refresh token for user from User Service
     */
    public String generateRefreshTokenForUser(String username, String userType, Long userId) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("userType", userType);
        claims.put("userId", userId);
    ...
    /**
     * Validate token without UserDetails (for User Service integration)
     */
